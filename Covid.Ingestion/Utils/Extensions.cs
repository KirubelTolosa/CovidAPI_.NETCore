...
namespace Covid.Injestion.Utils
{
    public static class Extensions
    {
        private static readonly Dictionary<Covid.Injestion.Utils.Metrics, Covid.BLL.Service.Utils.Metrics> MetricsMap = new Dictionary<Covid.Injestion.Utils.Metrics, Covid.BLL.Service.Utils.Metrics>
        {
            {
        ...
        private static readonly Dictionary<Covid.Injestion.Utils.Locations, Covid.BLL.Service.Utils.Locations> LocationsMap = new Dictionary<Covid.Injestion.Utils.Locations, Covid.BLL.Service.Utils.Locations>
        {
            {
